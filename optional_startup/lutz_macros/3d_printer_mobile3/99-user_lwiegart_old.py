pv_mag='XF:11IDM-M3{IO}DO:1-Cmd'
...
y_head_printing_p2 = 53.0
# deposition with mk1 printhead
def deposition_mk1_printer(speed=10.,dist1=1,dist2=40,pre_depos=.2,post_depos=0,liftoff=False,unprime=True,temperature=225,nozzle_height=y_head_printing_p2,nozzle_size=.7,filament_size=.9,motion_only=False):
